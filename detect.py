        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                temp = {
                    ...
                    'stats': getTemperature.getStas(temperature, [int(x1), int(y1), int(x2), int(y2)])
                }
                ...
                bbox = patches.Rectangle((x1, y1), box_w*1.2, box_h*1,.2, linewidth=1, edgecolor=color, facecolor="none")
